...
// 	bool _was_set;
// public:
// 	constexpr arg_container_t() noexcept :
// 		_short{}, _long{}, _desc{},
// 		_optional{false},
// 		_default{}, _value{},
// 		_was_set{false} { /* NOP */ }
...
// 	std::any value() const noexcept { return _value; }
// 	void value(const std::any value) noexcept { _value = value; }

// 	bool was_set() const noexcept { return _was_set; }
// 	void was_set(const bool was_set) noexcept { _was_set = was_set; }
// }
...
// extern std::unordered_map<std::string, arg_container_t> _args;
